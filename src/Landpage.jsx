    ...
    <div className="dark bg-background-dark font-display text-gray-100 min-h-screen flex flex-col overflow-x-hidden selection:bg-primary/30">
      ...
      <section className="border-y border-white/5 bg-surface-dark/50 backdrop-blur-sm relative z-20">
        <div className="max-w-7xl mx-auto px-6 py-8 grid grid-cols-2 md:grid-cols-4 gap-8">
            <StatItem number="12,405" label="Active Users" />
            <StatItem number="84" label="Alerts Today" />
      ...
      <section className="py-24 px-6 relative">
         <div className="max-w-7xl mx-auto">
            <div className="flex justify-between items-end mb-12">
                ...
                <button className="hidden md:flex text-primary hover:text-white items-center gap-2 transition">
            ...
            <div className="glass-panel border border-primary/20 rounded-3xl p-8 md:p-16 relative overflow-hidden flex flex-col md:flex-row items-center gap-12">
                ...
                <div className="flex-1 space-y-8 relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <button className="flex items-center gap-3 bg-white text-background-dark px-6 py-3 rounded-lg font-bold hover:bg-gray-200 transition">
                            <Smartphone size={20} /> App Store
                        </button>
                        <button className="flex items-center gap-3 glass-panel border border-white/20 px-6 py-3 rounded-lg font-bold hover:bg-white/10 transition">
                             Play Store
                        </button>
                    </div>
                </div>
